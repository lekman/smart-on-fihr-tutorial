(function() {
  ...
  var DSN = 'https://837c3103d0e963bc0a22cb9f76d57d49@o4509752039243776.ingest.de.sentry.io/4511258733445200';
  ...
  else if (path.indexOf('launch-smart-sandbox') !== -1) role = 'launch-smart-sandbox';
  ...
  if (window.Sentry.logger && typeof window.Sentry.logger.info === 'function') {
    window.Sentry.logger.info('Page loaded', { role: role, url: window.location.href });
  }
})();
